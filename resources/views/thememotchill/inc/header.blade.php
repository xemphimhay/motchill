                        ...
                        <ul class="">
                            <li class="search-box dropdown-hover" href="javascript:;">
                                <form id="search" name="search" method="get" action="/">
                                    <input type="text" id="keyword" name="search" class="search_wd form-control"
                                        value="{{ request('search') }}" placeholder="V.d: tên phim, tên diễn viên..."
                                        autocomplete="off" />

                                    <button class="submit search_submit icon-btn" id="searchbutton" type="submit"
                                        name="submit">
                                        <svg>
                                            <use xlink:href="/themes/motchill/static/sprite.svg#icon-search"></use>
                                        </svg>
                                    </button>
                                </form>
